...
- Learn v2 eval includes concept-quality gates for activation surface, broad-scope evidence strength, confidence caps, command-policy extraction, active reliability/durability, counterevidence, risky suppression, memory-admission activation exclusion for one-off/rejected/superseded concepts, conditional-admission non-overlearning checks, open-world grounding authority/precedence/evidence-separation checks, and privacy boundaries.
