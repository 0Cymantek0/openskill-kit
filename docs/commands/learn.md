...
- Learn v2 conditional learning keeps single-support contrastive hypotheses as weak observations by default. Repeated support or explicit durable language is required before a conditional hypothesis becomes a reviewable concept candidate and behavior atom.
