...
const MCP_TOOL_DESCRIPTORS: McpToolDescriptor[] = [
  ...
  descriptor("osk_get_learn_v2_artifact_paths", "learning", "read-only"),
  ...
  descriptor("osk_get_concept_store", "learning", "read-only"),
  ...
  descriptor("osk_prepare_learn_v2_behavior_eval_requests", "eval", "local-write"),
  ...
  descriptor("osk_apply_learn_v2_behavior_eval_outputs", "eval", "local-write"),
